...
window.addEventListener("load", function(){
    ...
    document.getElementById("demo").innerHTML = "Page loading...";
    ...
    function ajaxCallback(){
        ...
        if(this.readyState == 4     // operation is complete
            ...
            document.getElementById("demo").innerHTML = "Data successful loaded";
            ...
            document.getElementById("demo").innerHTML = "Welcome messages:";
    ...
    function loadData(){
        ...
        ajaxObject.send();
        document.getElementById("demo").innerHTML = "Data is loading";
    }
